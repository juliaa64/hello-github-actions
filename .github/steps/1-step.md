...
1. En la pestaña **Code** de tu repositorio, crea una nueva rama llamada `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/juliaa64/hello-github-actions/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
